...
#define OS_TICKS_PER_SEC          CONFIG_BSP_RTC_TICK_HZ   /* Set the number of ticks in one second    */
...
#define OS_TMR_CFG_TICKS_PER_SEC CONFIG_BSP_RTC_TICK_HZ   /*     Rate at which timer management task runs (Hz)            */
