...
int ieee80211_channel_to_frequency(int chan, enum ieee80211_band band)
{
	...
	if (band == IEEE80211_BAND_5GHZ) {
            // NOTE - Channel numbers do not work here for 802.11p
            //   Using the math below, 802.11p channels should be 170 - 185
            //   But according to http://en.wikipedia.org/wiki/List_of_WLAN_channels
            //   Channels 183-185 are in the 4GHz range?  So hack this here to avoid 182-185
            //   Original if (chan >= 182 && chan <= 196)
		if (chan >= 186 && chan <= 196)
			return 4000 + chan * 5;
		else
			return 5000 + chan * 5;
...
{
    // NOTE:  This math will return the same channel numbers for 2 sets of freqs 
    //   4910 - 4925 = Channels 182 - 185
    //   5910 - 5925 = Channels 182 - 185
